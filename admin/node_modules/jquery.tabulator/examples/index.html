...
// 			  	groupBy:["destination", "clean_outside"],
// 			  	// pagination:"local", //enable local pagination.
				ajaxURL:"ajax_sim.php",
// 			  	groupHeader:function(value, count, data, group){
// 			  	    return '<div style="background: blue;">' + value + "<span style='color:#d00; margin-left:10px;'>(" + count + " item)</span></div>";
// 			  	},
			  	ajaxFiltering:true,


			  	columns:[
			  	{title:"id", field:"id", editor:"number"},
			  	...
			  	{title: "Reg", field: "reg", width:80, sorter:"alphanum", sortable: true, bottomCalc:"count", topCalc:"count"},
			  	{title: "User", field: "user_name", width:150, sorter:"alphanum", sortable: true, bottomCalc:"count", topCalc:"count", editor:"input", editable:function(cell){
			  		console.log("e", cell.getData().dblClick);
			  		return !!cell.getData().dblClick;
			  	}, cellClick:function(e, cell){
			  		var data = cell.getData();
			  		console.log("c", data.dblClick);
			  		if(!data.dblClick){
			  			setTimeout(function(){
				  			data.dblClick = setTimeout(function(){
				  				clearTimeout(data.dblClick);
				  				data.dblClick = false;
				  			}, 200);
			  			}, 10);
			  		}else{
